...
| 4 | Assistant actions: wire Generate, Rewrite, Check, preview, accept/reject, and version-safe conflict handling from the editor-local controls | Planned | Create after Phase 3.5 is implemented |
