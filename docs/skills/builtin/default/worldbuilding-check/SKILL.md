...
This source skill has no required helper scripts. The Milestone 3.5 rewrite works entirely through Writer-native diagnosis and canon-safe recommendations.
