...
Emotional beat shaping for authors who want scenes, chapters, or outlines to land as felt experience instead of mechanical event sequence.
...
3. Mark the key emotional moments that must exist, escalate, or echo later.
...
- Do not propose Story Bible changes unless a beat depends on canon the author wants recorded.
